...
```json
{"summary":"…","spec_conformance":"full","tests_ran":"policy","tests_detail":"…","findings":[{"id":"…","severity":"blocker|major|minor|nit","location":"file:line","rule":"correctness","problem":"…","fix":"…"}],"approve":true|false}
```
